...
public interface MobileCarriers {
	...
	public static String CARRIER_NAME_T_MOBILE = "T-Mobile";
	...
	public static String CARRIER_NAME_TRACFONE = "Tracfone";

	public static String CARRIER_NAME_METRO_PCS = "Metro Pcs";

	public static String CARRIER_NAME_BOOST_MOBILE = "Boost Mobile";

	public static String CARRIER_NAME_CRICKET = "Cricket";

	public static String CARRIER_NAME_NEXTEL = "Nextel";

	public static String CARRIER_NAME_ALLTEL = "Alltel";

	public static String CARRIER_NAME_PTEL = "Ptel";

	public static String CARRIER_NAME_SUNCOM = "Suncom";

	public static String CARRIER_NAME_QUEST = "Quest";

	public static String CARRIER_NAME_US_CELLULAR = "US Cellular";
