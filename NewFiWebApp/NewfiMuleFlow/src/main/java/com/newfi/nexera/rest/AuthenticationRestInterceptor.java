...
public class AuthenticationRestInterceptor implements Callable
{
    ...
    private static final Logger LOG = Logger.getLogger( AuthenticationRestInterceptor.class );
    ...
    public Object onCall( MuleEventContext eventContext ) throws Exception
    {
        ...
        message.setOutboundProperty( NewFiConstants.CONSTANT_OP_NAME, authenticateVO.getOpName() );
    ...
    private String[] getArrayForOperation( AuthenticateVO authenticateVO )
    {
        ...
        if ( authenticateVO.getOpName().equals( WebServiceOperations.OP_NAME_AUTH_GET_USER_AUTH_TICET ) ) {
        ...
        } else if ( authenticateVO.getOpName().equals( WebServiceOperations.OP_NAME_AUTH_GET_PML_USER_AUTH_TICET ) ) {
            LOG.info( "Operation Chosen Was GetUserAuthTicket " );
