...
public class LoanVO
{
    ...
    {
        return "Ticket passed by user " + sTicket + " Template name for loan " + sTemplateName
            + " Document Type given by user " + documentType + " Condition specified by user " + condition
            + " Notes given by user " + notes + " Format given by user " + format + " LockRateTemplate given by user "
            + IlpTemplateId + " RequestedRate given by user " + requestedRate + "Request Fee given by user " + requestedFee
            + " DocId given by user " + docId + " AppCode given by user " + appCode;
    }
    ...
    /**
     * @param sDataContentMap
     *            the sDataContentMap to set
     */
