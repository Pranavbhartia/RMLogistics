...
public class RestInterceptor implements Callable {
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
		...
		String newfiUsernameBackup = bundle
		        .getString(NewFiConstants.NEWFI_USERNAME_BACKUP);
		String newfiPasswordBackup = bundle
		        .getString(NewFiConstants.NEWFI_PASSWORD_BACKUP);
			...
			if (NewFiManager.userTicket == null) {
				...
				if (NewFiManager.userTicket == null) {
					...
					utils.getUserTicket(newfiUsernameBackup,
					        newfiPasswordBackup);
					if (NewFiManager.userTicket != null) {
						LOG.info("Ticket generated With Back Up Account "
		...
		if (NewFiManager.userTicket == null
		        && (restParameters.getLoanVO().getsTicket() == null || restParameters
		                .getLoanVO().getsTicket().equalsIgnoreCase(""))) {
