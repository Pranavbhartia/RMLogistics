...
public class PreQualificationletter {
	 ...
	 * 
	 * String basePath =
	 * "D:/Abhishek-Project/RareMile_Projects/Nexera/Servers/apache-tomcat-7.0.34/webapps/NewfiWeb"
	 * ;
	 * 
	 * String absoluteFilePath = ""; absoluteFilePath = basePath +
	 * File.separator + "resources" +File.separator +"images"+
	 * File.separator+"newfi_logo_big.png"; File file = new
	 * File(absoluteFilePath); System.out.println(file.getAbsolutePath());
	 * 
	 * }
	 */
