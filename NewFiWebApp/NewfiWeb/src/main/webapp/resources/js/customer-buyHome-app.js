...
function paintCustomerApplicationPurchasePageStep1a() {
    ...
    var saveAndContinueButton = $('<div>').attr({
        ...
        if (inputState != undefined && inputState != "" && city != undefined && city != "" && zipCode != undefined && zipCode != "") {
            ...
            if (isSellYourhome == 'Yes') appUserDetails.homeToSell = true;
            else appUserDetails.homeToSell = false;
            //appUserDetails.buyHome = buyHome;
...
function paintSpouseSaleOfCurrentHome() {
    ...
    questionsContainer10.append(quesHeaderTextCont).append(questionsContainer).append(quesHeaderTextCont2).append(quesHeaderTextCont31).append(questionsContainer1).append(quesHeaderTextCont3).append(questionsContainer2).append(quesHeaderTextCont4).append(questionsContainer3).append(saveAndContinueButton);
