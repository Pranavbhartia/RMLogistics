			...
			<div class="container-row row clearfix">
				...
				<div class="login-form-wrapper">
					...
					<div class="login-input-cont">
						<input class="login-input login-input-username" placeholder="Username">
					</div>
					<div class="login-input-cont">
						<input class="login-input login-input-pwd" placeholder="Password">
					</div>
					<div class="login-submit-button">Login to your account</div>
					<div class="forgot-pwd">Forgot Password?<span class="forgot-pwd-link">Click here</span></div>
				</div>
			</div>
		</div>
