...
public class WorkflowServiceImpl implements WorkflowService
{
    ...
    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#setWorkflowItemIntoExecution(com.nexera.workflow.bean.WorkflowItemMaster)
     */
    @Override
    @Transactional
    public WorkflowItemExec setWorkflowItemIntoExecution( WorkflowExec parentWorkflow, WorkflowItemMaster workflowItemMaster,
    ...
    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#getWorkflowItemMasterListByWorkflowMaster(com.nexera.workflow.bean.WorkflowMaster)
     */
    @Override
    @Transactional
    ...
    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#updateWorkflowExecStatus(com.nexera.workflow.bean.WorkflowExec)
     */
    @Override
    @Transactional
    ...
    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#updateWorkflowItemExecutionStatus(com.nexera.workflow.bean.WorkflowItemExec)
     */
    @Override
    @Transactional
    ...
    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#getWorkflowItemListByParentWorkflowExecItem(com.nexera.workflow.bean.WorkflowItemExec)
     */
    @Override
    @Transactional
    public List<WorkflowItemExec> getWorkflowItemListByParentWorkflowExecItem( WorkflowItemExec workflowItemExecution )
    {
        ...
        return workflowItemExecDao.getWorkflowItemListByparentWorkflowExecItem( workflowItemExecution );
    }


    /* (non-Javadoc)
     * @see com.nexera.workflow.service.WorkflowService#checkIfOnSuccessOfAnotherItem(com.nexera.workflow.bean.WorkflowItemMaster)
     */
    @Override
