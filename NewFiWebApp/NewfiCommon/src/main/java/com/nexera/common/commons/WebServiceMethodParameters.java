 ...
 *
 */
public class WebServiceMethodParameters {

	public static String PARAMETER_USERNAME = "userName";

	public static String PARAMETER_PASSWORD = "passWord";

	public static String PARAMETER_CUSTOMER_CODE = "customerCode";

	public static String PARAMETER_S_TICKET = "sTicket";

	public static String PARAMETER_S_LOAN_NAME = "sLoanName";

	public static String PARAMETER_S_DATA_CONTENT_MAP = "sDataContentMap";
