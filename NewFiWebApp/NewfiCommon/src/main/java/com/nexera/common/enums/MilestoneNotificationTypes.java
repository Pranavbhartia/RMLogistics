...
public enum MilestoneNotificationTypes {
	CREDIT_SCORE_NOTIFICATION_TYPE("CREDIT_SCORE_NOTIFICATION"), SYS_EDU_NOTIFICATION_TYPE(
	        ...
	        "APPRAISAL_NOTIFICATION"), UW_NOTIFICATION_TYPE("UW_NOTIFICATION"), WATCH_ALERT_NOTIFICATION_TYPE(
	        "WATCH_ALERT_NOTIFICATION"), COMPLETE_APPLICATION_NOTIFICATION_TYPE(
	        "COMPLETE_APPLICATION_NOTIFICATION"), TEAM_ADD_NOTIFICATION_TYPE(
	        "TEAM_ADD_NOTIFICATION"), NEEDS_LIST_SET_TYPE("NEEDS_LIST_SET_TYPE"), VERIFY_EMAIL_ALERT("VERIFY_EMAIL");
