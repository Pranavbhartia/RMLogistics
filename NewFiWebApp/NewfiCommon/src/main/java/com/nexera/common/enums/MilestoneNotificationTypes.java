...
public enum MilestoneNotificationTypes {
	CREDIT_SCORE_NOTIFICATION_TYPE("CREDIT_SCORE_NOTIFICATION"), SYS_EDU_NOTIFICATION_TYPE(
	        ...
	        "APP_FEE_NOTIFICATION"), LOCK_RATE_NOTIFICATION_TYPE(
	        "LOCK_NOTIFICATION"), APPRAISAL_NOTIFICATION_TYPE(
	        "APPRAISAL_NOTIFICATION"), UW_NOTIFICATION_TYPE("UW_NOTIFICATION");
