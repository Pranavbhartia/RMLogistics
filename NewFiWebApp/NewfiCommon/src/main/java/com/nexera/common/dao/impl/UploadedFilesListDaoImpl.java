...
public class UploadedFilesListDaoImpl extends GenericDaoImpl implements UploadedFilesListDao
{
    ...
    public void updateIsAssignedToTrue( Integer fileId )
    {
        ...
        Session session = sessionFactory.getCurrentSession();
        String hql = "UPDATE UploadedFilesList set isAssigned = :isAssigned " + "WHERE id = :id";
    ...
    public void updateFileInLoanNeedList( Integer needId, Integer fileId )
    {
        ...
        Session session = sessionFactory.getCurrentSession();
        String hql = "UPDATE LoanNeedsList  set uploadFileId = :uploadFileId " + "WHERE id = :id";
        Query query = session.createQuery( hql );
    ...
    {
        Session session = sessionFactory.getCurrentSession();
        Criteria criteria = session.createCriteria( UploadedFilesList.class ).add(
            Restrictions.le( "uploadedDate", timeBeforeCallMade ) );
        return criteria.list();
    }
