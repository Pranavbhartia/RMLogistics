...
public class LoanVO implements Serializable {
	...
	private List<LoanDetailVO> loanDetails;
	...
	private List<LoanTeamVO> loanTeam;
	public int getId() {
		return id;
	}
	...
	public void setCurrentLoanMilestone(LoanMilestoneMasterVO currentLoanMilestone) {
	...
	public List<LoanDetailVO> getLoanDetails() {
		return loanDetails;
	}
	public void setLoanDetails(List<LoanDetailVO> loanDetails) {
	...
	public List<LoanTeamVO> getLoanTeam() {
		return loanTeam;
	}
	public void setLoanTeam(List<LoanTeamVO> loanTeam) {
