...
public enum Milestones {
	App1003(1, "1003"), AUSUW(2, "AUSUW"), QC(3, "QC"), LM_DECISION(4,
	        ...
	        9, "OTHER"), APP_FEE(10, "APP_FEE"), LOAN_APPROVED(11, "LOAN_APPROVED"),DOCS_OUT(12, "DOCS_OUT"), PRE_QUAL(13,"PRE_QUAL"),DELETE(14,"DELETE"),NEWFI_LOAN_STATUS(15,"NEWFI_LOAN_STATUS");
