...
public enum LOSLoanStatus {
	...
	LQB_STATUS_LEAD_NEW(12, "New Loan"), LQB_STATUS_LEAD_CANCELED(15,
	        ...
	        17), LQB_STATUS_LOAN_OPEN(0), LQB_STATUS_PRE_QUAL(1,
	        "Pre Qualified"), LQB_STATUS_REGISTERED(3), LQB_STATUS_PRE_PROCESSING(
	        29), LQB_STATUS_PROCESSING(22), LQB_STATUS_DOCUMENT_CHECK(30), LQB_STATUS_DOCUMENT_CHECK_FAILED(
	        31), LQB_STATUS_LOAN_SUBMITTED(28, "1003 Complete"), LQB_STATUS_PRE_UNDERWRITING(
