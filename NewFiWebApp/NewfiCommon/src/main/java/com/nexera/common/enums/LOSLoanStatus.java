...
public enum LOSLoanStatus {
	...
	LQB_STATUS_LEAD_NEW(12, "New Loan"), LQB_STATUS_LEAD_CANCELED(15,
	        ...
	        29), LQB_STATUS_PROCESSING(22, "Processing",3), LQB_STATUS_DOCUMENT_CHECK(30), LQB_STATUS_DOCUMENT_CHECK_FAILED(
	        ...
	        2, "Pre-Approved"), LQB_STATUS_APPROVED(4, "Approved"), LQB_STATUS_CONDITION_REVIEW(
	        ...
	        7), LQB_STATUS_LOAN_CANCELED(9, "Cancelled"), LQB_STATUS_LOAN_SUSPENDED(8,
