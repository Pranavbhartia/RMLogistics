...
public enum LOSLoanStatus {
	...
	LQB_STATUS_LEAD_NEW(12, "New Loan"), LQB_STATUS_LEAD_CANCELED(15,
	        ...
	        17), LQB_STATUS_LOAN_OPEN(0), LQB_STATUS_PRE_QUAL(1, "Pre Qualified"), LQB_STATUS_REGISTERED(
	        ...
	        4, "Approved"), LQB_STATUS_CONDITION_REVIEW(33), LQB_STATUS_FINAL_UNDER_WRITING(
	        ...
	        36), LQB_STATUS_DOCS_OUT(5, "Docs Out"), LQB_STATUS_DOCS_BACK(24), LQB_STATUS_FUNDING_CONDITIONS(
	        25), LQB_STATUS_FUNDED(6, "Funded",1), LQB_STATUS_RECORDED(19), LQB_STATUS_FINAL_DOCS(
	        ...
	        "Suspended",2), LQB_STATUS_LOAN_DENIED(10, "Denied",3), LQB_STATUS_LOAN_WITHDRAWN(
	        48, "Withdrawn",4), LQB_STATUS_LOAN_ARCHIVED(49, "Archived",5), LQB_STATUS_LOAN_OTHER(
