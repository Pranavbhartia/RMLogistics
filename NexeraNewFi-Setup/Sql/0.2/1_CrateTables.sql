...
CREATE TABLE `internaluserdetails` (
  ...
  `lqb_auth_token` tinytext,
  `lqb_expiry_time` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `loan` (
  ...
  `lock_status` enum('0','1','2') DEFAULT '0',
  `locked_rate` varchar(50) DEFAULT NULL,
  `purchase_document_expiry_date` bigint(20) DEFAULT NULL,
  `locked_rate_data` varchar(1000) DEFAULT NULL,
  `lock_expiration_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `template` VALUES (1,'PAYMENT_TEMPLATE_ID','Payment Mail','2015-04-10 12:53:34','80be7cc4-767a-44fc-9b0c-202302000c5b','Payment has been made on your newfi account.'),(2,'NEW_USER_TEMPLATE_ID','New User Mail','2015-04-10 12:53:34','1d11f2a2-1aa0-455a-aba7-bc05442800e3','Welcome to newfi.'),(3,'NEW_NOTE_TEMPLATE','New Note Created','2015-04-10 12:53:34','d18778b1-e69c-4566-a3aa-24d299b0156a','An update was posted to the newfi portal.'),(4,'PAYMENT_UNSUCCESSFUL_TEMPLATE_ID','Payment Failure','2015-04-10 12:53:34','e2227e0e-deb4-4db0-9642-74ab494612bf','Your newfi payment was unsuccessful. So please login and retry the payment.'),(5,'TEMPLATE_WORKFLOW_COMPLETION','Milestone Template','2015-04-10 12:53:34','01efab20-fe83-4a79-bdc5-c3abf624526b','Your newfi loan status has changed.'),(6,'WELCOME_TO_NEWFI_TEMPLATE_ID','Welcome to New Fi','2015-04-10 12:53:34','bdfe9357-5896-42c2-92e2-ccca4c5e8a34','Welcome to newfi.'),(7,'CREATED_ACCOUNT_PASSWORD_NOT_UPDATED_TEMPLATE_ID','Accoutn created but password not updated','2015-04-10 12:53:34','d5639bee-de0a-4020-a8c5-0ee97fe78add','Your newfi account password is not updated.'),(8,'FORGOT_YOUR_PASSWORD_TEMPLATE_ID','Forgot password','2015-04-10 12:53:34','d403d330-66f6-4dc1-b000-65f015525724','Reset password instructions have been sent.'),(9,'GET_TO_KNOW_NEWFI_TEMPLATE_ID','Getting to know newfi','2015-04-10 12:53:34','e4685b8a-510b-4abd-9ab0-0d5ba7cb5d24','Login to get to know newfi system.'),(10,'DRIP_RATE_ALERTS_TEMPLATE_ID','Drip rate alert','2015-04-10 12:53:34','77b26174-f10d-42fd-a07b-a1a92caefbf5','Your newfi loan rates can be checked now.'),(11,'APPLICATION_NOT_COMPLETE_TEMPLATE_ID','Application not completed','2015-04-10 12:53:34','42d0a140-e2e5-4a2d-a56e-c31aa6fa0a84','Your newfi application has not been completed yet.'),(12,'APPLICATION_NOT_YET_COMPLETED_TEMPLATE_ID','Application not yet complete','2015-04-10 12:53:34','0df21833-529b-4ffd-9e18-6f1725807705','Your newfi application has not been completed yet.'),(13,'APPLICATION_NOT_YET_COMPLETED_3_TEMPLATE_ID','Another reminder for application completion','2015-04-10 12:53:34','4bd53104-5ef4-4b43-bb1f-29d5bdd65b8c','Your newfi application has not been completed yet.'),(14,'APPLICATION_FINISHED_TEMPLATE_ID','New user mail','2015-04-10 12:53:34','9e6b9112-ce53-4711-82f8-c0e65533b5db','Your newfi application has been submitted.'),(15,'NO_PRODUCTS_AVAILABLE_TEMPLATE_ID','Products not available','2015-04-10 12:53:34','7adab089-3096-472f-a96e-77c435865c79','There wasn\'t any loan product match for you.'),(16,'FILE_INACTIVITY_TEMPLATE_ID','Loan file inactive','2015-04-10 12:53:34','8cf52fa8-251e-4dda-9f61-93c1365f42a1','Come back, We miss you!'),(17,'CREDIT_INFO_TEMPLATE_ID','Credit information template','2015-04-10 12:53:34','00c6add3-18cf-463e-9fe3-23c1f596535a','Your credit score is available now.'),(18,'RATE_LOCK_REQUESTED_TEMPLATE_ID','Rate lock request generated','2015-04-10 12:53:34','480842a3-6f2c-4796-b89d-3d25b1289ae8','Your rate lock request has been submitted.'),(19,'RATES_LOCKED_TEMPLATE_ID','Rate locked','2015-04-10 12:53:34','1f5dd899-7058-43c5-a482-fb11584fef32','A fantastic rate for your mortgage loan is now available.'),(20,'APPRAISAL_ORDERED_TEMPLATE_ID','Appraisal has been ordered','2015-04-10 12:53:34','a3c6de05-b72f-45fa-9d4b-8e4ceefc453c','We are now ready to order an appraisal on your newfi loan.'),(21,'APPLICATION_FEE_PAID_TEMPLATE_ID','Application fee paid','2015-04-10 12:53:34','dda6e20e-a5c3-4ed8-8aa8-653a76d0c134','Application fee has been paid on your newfi loan.'),(22,'APPRAISAL_ORDERED_PURCHASE_TEMPLATE_ID','Purchase ordered','2015-04-10 12:53:34','e2db053f-8d91-4151-af6e-1a0a1d9205ec','Appraisal has been ordered on your newfi loan.'),(23,'APPRAISAL_ORDERED_REFINANCE_TEMPLATE_ID','Refinance Ordered','2015-04-10 12:53:34','5a047650-188a-41a2-a8ac-361328e8ef5a','Appraisal has been ordered on your newfi loan.'),(24,'APPRAISAL_RECEIVED_TEMPLATE_ID','Appraisal received','2015-04-10 12:53:34','49e30cda-5508-4cad-98bf-18b886bc4cb9','Appraisal has been received on your newfi loan.'),(25,'PRUCHASE_AND_REFINANCE_REQUEST_TEMPLATE_ID','New Purchase and refinance request mail','2015-04-10 12:53:34','dcbfcaaa-c8c5-43ee-91df-70eb5ed27ca0','Copy of the homeowner’s insurance policy is now needed on your newfi loan.'),(26,'DISCLOSURES_AVAILABLE_TEMPLATE_ID','Disclosures are now avaliable','2015-04-10 12:53:34','d5ecbce6-7393-4d24-8442-704a5f563763','Your initial disclosures are ready to sign.'),(27,'DISCLOSURES_ARE_COMPLETE_TEMPLATE_ID','Disclosures completed','2015-04-10 12:53:34','ae12241f-cedb-468a-b6a2-655e4410a86e','Thank you for completing your disclosures.'),(28,'INITIAL_NEEDS_LIST_SET_TEMPLATE_ID','Initial needs list set','2015-04-10 12:53:34','5fb56f23-744a-4a4e-8882-2ffbe1bfd45c','Needed items are added for your newfi loan.'),(29,'NEEDS_LIST_UPDATED_TEMPLATE_ID','Needs list updated','2015-04-10 12:53:34','0b9d1ab4-85c2-4bbe-b3fe-e5554c9c0f5f','Your Needs List Has Been Updated'),(30,'7_DAYS_AGED_DOCUMENT_TEMPLATE_ID','7 days aged document','2015-04-10 12:53:34','c05ff2de-f3b0-43d2-acbc-5f6766f17ff3','We are still waiting for your documents.'),(31,'LOAN_PREAPPROVED_PRUCHASE_TEMPLATE_ID','loan preapproved','2015-04-10 12:53:34','11257e41-2c96-4200-8a26-ffdec9f71078','Your newfi loan has been Pre Approved.'),(32,'LOAN_APPROVED_WITH_CONDITIONS_TEMPLATE_ID','Loan approved with conditions','2015-04-10 12:53:34','1553a6a2-f35d-492c-927f-f1c42f01d77f','Your newfi loan has been approved with conditions.'),(33,'LOAN_SUSPENDED_TEMPLATE_ID','loan suspended','2015-04-10 12:53:34','f14ce559-a819-4d31-a284-31b7a93f9abd','Your newfi loan has been suspended.'),(34,'LOAN_DECLINED_TEMPLATE_ID','loan declined','2015-04-10 12:53:34','cff127f6-9e08-4b53-bbfe-14d60d83e601','Your newfi loan has been declined.'),(35,'LOAN_CLEAR_TO_CLOSE_TEMPLATE_ID','Loan clear to close','2015-04-10 12:53:34','fd85f95d-baf7-44cc-9dc4-282ddb2706ee','Your newfi loan is clear to close.'),(36,'FINAL_DOCS_SENT_TEMPLATE_ID','Final Docs Sent Email','2015-04-10 12:53:34','852fcf28-1c94-40e2-bab4-145a3790f5fe','Final docs have been sent on your newfi loan/'),(37,'DOCS_ASSIGNED_TO_FUNDER_TEMPLATE_ID','Docs Sent Email','2015-04-10 12:53:34','a77f61e9-66eb-4304-a205-2959be561f58','Docs have been sent on your newfi loan.'),(38,'NO_PRODUCTS_AVAILABLE_LOAN_MANAGER_TEMPLATE_ID','No producst available','2015-04-10 12:53:34','f1329d6b-11b9-4fc6-a10f-a595125250de','There wasn\'t any loan product match for you.'),(39,'WELCOME_TO_NEWFI_REALTOR_TEMPLATE_ID','No producst available','2015-04-10 12:53:34','8800b478-b1cb-4bf7-a324-1280cf9e1712','There wasn\'t any loan product match for you.'),(40,'WELCOME_TO_NEWFI_TITLE_COMPANY_TEMPLATE_ID','Welcome mail for title company','2015-04-10 12:53:34','9bf78a7a-3a55-47e8-93ef-33c9eefcf24b','Welcome to newfi.'),(41,'WELCOME_TO_NEWFI_HOME_OWNER_INSURANCE_COMPANY_TEMPLATE_ID','Welcome mail for home insurance owner company','2015-04-10 12:53:34','0e2334f7-07ce-4992-8c14-a98ebd3b8258','Welcome to newfi.'),(42,'PRE_QUAL_LETTER_TEMPLATE_ID','Prequal Letter Template','2015-04-10 12:53:34','ef40dd3a-acd4-41b2-9c98-72ce2d4eb414','Your PreQualification letter has been sent to your email.');
...
-- Dump completed on 2015-06-10 16:21:21
